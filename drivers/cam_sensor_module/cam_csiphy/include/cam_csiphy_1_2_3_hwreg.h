...
struct
csiphy_reg_t csiphy_2ph_v1_2_3_reg[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
...
struct csiphy_reg_t
	...
	},
	{
		...
		{0x0710, 0x52, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0738, 0x1F, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x075C, 0xC0, 0x00, CSIPHY_SKEW_CAL},
		{0x0760, 0x0D, 0x00, CSIPHY_SKEW_CAL},
		{0x0800, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
	},
	{
		{0x0230, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		...
		{0x0260, 0x0D, 0x00, CSIPHY_SKEW_CAL},
		{0x0800, 0x00, 0x00, CSIPHY_SKEW_CAL},
		{0x0000, 0x00, 0x00, CSIPHY_DNP_PARAMS},
		{0x0000, 0x00, 0x00, CSIPHY_DNP_PARAMS},
	},
	{
